...
#     print('{} : {}'.format(item, dictionary[item])) #pprint import pprint , pprint(dictionary) выведет словарь с новой строки
...
print(my_dict) # добавит в первый словарь пункты из второго, если есть одинаковые ключи = перезапишет из второго
#множества
