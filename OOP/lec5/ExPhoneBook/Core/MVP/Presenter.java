package lec5.ExPhoneBook.Core.MVP;

import lec5.ExPhoneBook.Core.Models.Contact;
import lec5.ExPhoneBook.UI.NewConsoleView;

public class Presenter {
    private Model model;
    private View view;

    public Presenter(NewConsoleView view2, String pathDb) {
        this.view = view2;
