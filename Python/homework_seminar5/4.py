...
print("Всего 10 конфет, за один ход можно взять от 1 до 2, выиграет тот, кто заберет последние конфеты. Два игрока")
candy = 10
...
who_is_first(x,y)
# первому игроку нужно забрать 20 конфет, и далее ходить так, чтобы остаток конфет делился на 29
